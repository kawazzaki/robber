...
###########
var param_max_rooms = CommandParameter.new()
param_max_rooms.name = "max_rooms"
param_max_rooms.type = TYPE_INT
param_max_rooms.default = 5
param_max_rooms.helpText = "Number of rooms to generate"
...
func _ready() -> void:
	DebugConsole.add_command("bl",build,self,["max"])
